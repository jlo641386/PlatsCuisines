package fr.uppa.platscuisines.db.sqlasset;
...
class VersionComparator implements Comparator<String> {
     ...
     * @throws fr.uppa.platscuisines.db.sqlasset.SQLiteAssetHelper.SQLiteAssetException thrown if the strings are not in the correct upgrade
     * script format of:
